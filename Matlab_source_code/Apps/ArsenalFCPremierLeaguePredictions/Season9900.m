function varargout = Season9900(varargin)
% SEASON9900 MATLAB code for Season9900.fig
%      SEASON9900, by itself, creates a new SEASON9900 or raises the existing
%      singleton*.
%
%      H = SEASON9900 returns the handle to a new SEASON9900 or the handle to
%      the existing singleton*.
%
%      SEASON9900('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEASON9900.M with the given input arguments.
%
%      SEASON9900('Property','Value',...) creates a new SEASON9900 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Season9900_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Season9900_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Season9900

% Last Modified by GUIDE v2.5 01-May-2014 15:51:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Season9900_OpeningFcn, ...
                   'gui_OutputFcn',  @Season9900_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Season9900 is made visible.
function Season9900_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Season9900 (see VARARGIN)

% Choose default command line output for Season9900
handles.output = hObject;
set(handles.axes3,'visible','off'); %set axes3 visibility to off when gui is loaded
axes(handles.axes1); %focus on axes 1
Points_9900 = [3;6;7;7;10;10;13;16;19;19;22;25;26;26;29;32;35;36;36;39;40;43;44;44;44;47;48;48;51;54;57;60;63;66;69;72;73;73]; %data
plot(Points_9900,'Color','y','Marker','.'); %plot data and change style
...
% UIWAIT makes Season9900 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Season9900_OutputFcn(hObject, eventdata, handles) 
